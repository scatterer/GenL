...
from . import Control, DynamicResult, Instrument, Layer, calc_dynamic_density
...
class DynamicModel:
    def __init__(
        ...
        self.poscar_dir = ROOT / "kinematic_and_dynamic" / "POSCAR"
        self.form_factor_dir = ROOT / "kinematic_and_dynamic" / "Form_Factor_and_Elemental_data"
