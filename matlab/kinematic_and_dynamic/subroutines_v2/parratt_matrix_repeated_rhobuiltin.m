...
if ~full_stack
  ...
  if stack{o}.roughness
    ...
    if control.pol == 0 || control.pol == 1
      output.refl = propagate_vectorized_chunks_opt(Q,lambda,rho_0r,rho_1r,round(stack{1}.N),rho_restr,dz,stack{o}.sigma,control.pol);

    elseif control.pol == 2
      refl_p = propagate_vectorized_chunks_opt(Q,lambda,rho_0r,rho_1r,round(stack{1}.N),rho_restr,dz,stack{o}.sigma,0);
      refl_s = propagate_vectorized_chunks_opt(Q,lambda,rho_0r,rho_1r,round(stack{1}.N),rho_restr,dz,stack{o}.sigma,1);
